        ...
        >
          ...
          <div className="p-6">
            <p className="text-gray-700 mb-4">
              Are you sure you want to delete this lead selling entry?
            </p>
                ...
                <div className="space-y-2 text-sm">
                  {entry.customerId?.name && (
                    <div className="flex justify-between">
                      ...
                      <span className="font-medium text-gray-900">{entry.customerId.name}</span>
                    </div>
                  )}
                  {entry.weight && (
                    <div className="flex justify-between">
                  ...
                  {entry.rate && (
                    <div className="flex justify-between">
                      ...
                      <span className="font-medium text-gray-900">Rs {entry.rate}</span>
                    </div>
                  )}
                  {entry.credit && (
                    <div className="flex justify-between">
