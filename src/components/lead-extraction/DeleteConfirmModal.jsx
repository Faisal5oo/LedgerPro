        ...
        >
          ...
          <div className="p-6">
            <p className="text-gray-700 mb-4">
              Are you sure you want to delete this lead extraction entry?
            </p>
            ...
            {entry && (
              <div className="bg-gray-50 rounded-lg p-4 mb-6">
                <div className="space-y-2 text-sm">
                  ...
                  {entry.batteryWeight && (
                    <div className="flex justify-between">
                      <span className="text-gray-500">Battery Weight:</span>
                      <span className="font-medium text-gray-900">{entry.batteryWeight} kg</span>
                    </div>
                  )}
                  {entry.leadWeight && (
                    <div className="flex justify-between">
                      <span className="text-gray-500">Lead Weight:</span>
                      <span className="font-medium text-gray-900">{entry.leadWeight} kg</span>
                    </div>
                  )}
                  {entry.leadReceived && (
                    <div className="flex justify-between">
                      <span className="text-gray-500">Lead Received:</span>
                      <span className="font-medium text-gray-900">{entry.leadReceived} kg</span>
                    </div>
                  )}
                </div>
              </div>
