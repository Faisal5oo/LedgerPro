                ...
                <div className="space-y-2 text-sm">
                  {entry.batteryType && (
                    <div className="flex justify-between">
                      ...
                      <span className="font-medium text-gray-900">{entry.batteryType}</span>
                    </div>
                  )}
                  {entry.totalWeight && (
                    <div className="flex justify-between">
                      <span className="text-gray-500">Weight:</span>
                      <span className="font-medium text-gray-900">{entry.totalWeight} kg</span>
                    </div>
                  )}
                  {entry.ratePerKg && (
                    <div className="flex justify-between">
                      <span className="text-gray-500">Rate:</span>
                      <span className="font-medium text-gray-900">Rs {entry.ratePerKg}</span>
                    </div>
                  )}
                  {entry.credit && (
                    <div className="flex justify-between">
                      <span className="text-gray-500">Credit:</span>
                      <span className="font-medium text-gray-900">Rs {entry.credit}</span>
                    </div>
                  )}
                </div>
              </div>
